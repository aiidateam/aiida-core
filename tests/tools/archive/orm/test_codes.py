...
def test_that_solo_code_is_exported_correctly(tmp_path, clear_database_before_test, aiida_localhost):
    """
...
def test_input_code(tmp_path, clear_database_before_test, aiida_localhost):
    """
    This test checks that when a calculation is exported then the
...
def test_solo_code(tmp_path, clear_database_before_test, aiida_localhost):
    """
    This test checks that when a calculation is exported then the
    corresponding code is also exported.
    """
