...
We provide a :py:class:`aiida.manage.tests.unittest_classes.PluginTestCase` to be used for inheritance.
...
with the special runner in  :py:class:`aiida.manage.tests.unittest_classes.TestRunner`.
