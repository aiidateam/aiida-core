...
def test_downgrade_not_supported():
    """Downgrading out of ``main_0002`` is explicitly not supported."""
    from aiida.storage.sqlite_zip.migrations.versions.main_0002_migrate_legacy_code import downgrade

    with pytest.raises(NotImplementedError, match=r'Downgrade of main_0002\.'):
        downgrade()
