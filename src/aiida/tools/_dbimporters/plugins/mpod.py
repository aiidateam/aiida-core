...
from aiida.tools._dbimporters.baseclasses import CifEntry, DbImporter, DbSearchResults
...
class MpodDbImporter(DbImporter):
    ...
    def query(self, **kwargs):
        ...
        :return: an instance of
            :py:class:`aiida.tools._dbimporters.plugins.mpod.MpodSearchResults`.
        """
        import re
...
class MpodEntry(CifEntry):
    ...
    def __init__(self, uri, **kwargs):
        ...
        :py:class:`aiida.tools._dbimporters.plugins.mpod.MpodEntry`, related
        to the supplied URI.
        """
        super().__init__(
