...
from aiida.backends.sqlalchemy.migrations.utils import dblog_update
...
class TestDbLogMigrationRecordCleaning:
    ...
    def setup_db(self, perform_migrations: PsqlDostoreMigrator):  # pylint: disable=too-many-locals,too-many-statements
        ...
        from aiida.backends.sqlalchemy.migrations.utils.utils import dumps_json
...
def test_backward_migration(perform_migrations: PsqlDostoreMigrator):
    ...
    # migrate down
    perform_migrations.migrate_down('sqlalchemy@7ca08c391c49')  # e72ad251bcdb_dbgroup_class_change_type_string_values
