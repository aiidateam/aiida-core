...
class BandsData(KpointsData):
    ...
    class Model(KpointsData.Model):
        array_labels: t.Optional[list[str]] = MetadataField(description='Labels associated with the band arrays')
        ...
        if labels is not None:
            if isinstance(labels, str):
                ...
                raise ValidationError(
                    f'Band labels have an unrecognized type ({labels.__class__})'
                    'but should be a string or a list of strings'
                )
