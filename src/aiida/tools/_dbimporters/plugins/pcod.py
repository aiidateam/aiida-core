...
from aiida.tools._dbimporters.plugins.cod import CodDbImporter, CodEntry, CodSearchResults
...
class PcodDbImporter(CodDbImporter):
    ...
    def query(self, **kwargs):
        ...
        :return: an instance of
            :py:class:`aiida.tools._dbimporters.plugins.pcod.PcodSearchResults`.
        """
...
class PcodEntry(CodEntry):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :py:class:`aiida.tools._dbimporters.plugins.pcod.PcodEntry`, related
        to the supplied URI.
        """
