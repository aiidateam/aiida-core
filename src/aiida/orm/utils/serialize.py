...
def represent_callable(dumper: yaml.Dumper, value: t.Any, carry: Collection[ModuleType] = ()) -> yaml.ScalarNode:
...
def callable_constructor(loader: yaml.Loader, serialized: yaml.Node) -> t.Any:
