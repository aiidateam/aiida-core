...
from aiida.new_orm.abstract import AbstractNode
from aiida.new_orm.django import ObjectDoesNotExist
from aiida.new_orm.django import Computer
...
class Node(AbstractNode):
    ...
    def _add_dblink_from(self, src, label=None):
        if not isinstance(src, DjangoNode):
