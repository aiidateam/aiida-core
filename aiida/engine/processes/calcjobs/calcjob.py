...
class CalcJob(Process):
    ...
    def presubmit(self, folder: Folder) -> CalcInfo:
        ...
        from aiida.orm import AbstractCode, Code, Computer, InstalledCode, PortableCode, ContainerizedCode, load_node
        ...
        for code_info in calc_info.codes_info:
            ...
            this_code = load_node(code_info.code_uuid, sub_classes=(Code, InstalledCode, PortableCode, ContainerizedCode))
