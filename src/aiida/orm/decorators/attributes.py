...
class PossiblyUpdatableOnceStored(Storable, t.Protocol):
    """Marker protocol for instances that may have updatable attributes."""

    @classproperty
    def _updatable_attributes(cls: type[_NodeT]) -> tuple[str, ...]: ...  # noqa: N805


_NodeT = t.TypeVar('_NodeT', bound=PossiblyUpdatableOnceStored)
