## v0.12.5
### Minor bug fixes
- Make it possible to import archives that do not contain any nodes, but just other entities, such as computers [[#3315]](https://github.com/aiidateam/aiida-core/pull/3315)
