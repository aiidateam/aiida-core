# -*- coding: utf-8 -*-
#
# aida documentation build configuration file, created by
...
latex_documents = [
  ('index', 'aida.tex', u'aida Documentation',
...
man_pages = [
    ('index', 'aida', u'aida Documentation',
...
texinfo_documents = [
  ('index', 'aida', u'aida Documentation',
   u'Boris Kozinsky, Andrea Cepellotti & Giovanni Pizzi', 'aida', 'One line description of project.',
   'Miscellaneous'),
]
