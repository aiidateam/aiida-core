...
class ArithmeticAddParser(Parser):
    ...
    def parse(self, **kwargs):
        ...
        try:
            with self.retrieved.ctx.repository.open(self.node.get_option('output_filename'), 'r') as handle:
...
class SimpleArithmeticAddParser(Parser):
    ...
    def parse(self, **kwargs):
        ...
        with output_folder.ctx.repository.open(self.node.get_option('output_filename'), 'r') as handle:
            result = int(handle.read())
