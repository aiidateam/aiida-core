...
def aiida_config_factory():
    ...
    The factory is a context manager that returns a loaded :class:`aiida.manage.configuration._config.Config`. It
    ...
    :returns `~aiida.manage.configuration._config.Config`: The loaded temporary config.
    """
...
def aiida_profile_factory():
    ...
    requires a :class:`aiida.manage.configuration._config.Config` instance to which the profile is added. If another
...
def aiida_config(tmp_path_factory, aiida_config_factory):
    ...
    :returns :class:`~aiida.manage.configuration._config.Config`: The loaded temporary config.
    """
    with aiida_config_factory(tmp_path_factory.mktemp(secrets.token_hex(16))) as config:
        yield config
