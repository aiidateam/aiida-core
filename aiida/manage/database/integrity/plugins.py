...
def infer_calculation_entry_point(type_strings):
    ...
    """
    from aiida.plugins.entry_point import get_entry_points, EntryPoint
    ...
    entry_points_registry = [
        EntryPoint(name=key, value=value, group=entry_point_group)
        for key, value in registered_calculation_entry_points.items()
    ]
