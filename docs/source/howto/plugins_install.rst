...
For an overview of plugins that extend AiiDA's core capabilities (e.g. ``aiida-workgraph``, ``aiida-submission-controller``), see also `Non research-domain specific plugins to extend core functionality <https://aiida.net/news/posts/2024-12-13-core-plugins.html>`__.
