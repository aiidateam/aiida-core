...
def test_carried_modules_for_a_closure(monkeypatch):
    ...
    assert '__main__' in carried, "no reader can import another interpreter's entry point"
    assert 'json' not in carried, 'a module the reader can import stays a reference'
