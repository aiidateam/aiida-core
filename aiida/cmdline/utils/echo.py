...
def echo(message, bold=False, prefix=None):
    """
...
def echo_info(message, bold=False, prefix=None):
    """
...
def echo_success(message, bold=False, prefix=None):
    """
...
def echo_warning(message, bold=False, prefix=None):
    """
...
def echo_error(message, bold=False, prefix=None):
    """
    ...
    click.secho(message, bold=bold, err=True)


def echo_critical(message, bold=False, prefix=None, exit_status=1):
    """
