...
project = u'AiiDA'
copyright = u'2014, École Polytechnique Fédérale de Lausanne (EPFL), Switzerland, Laboratory of Theory and Simulation of Materials (THEOS). All rights reserved'
...
author = "Giovanni Pizzi, Andrea Cepellotti, Riccardo Sabatini, Nicola Marzari"
