...
def echo(message: t.Any, fg: str | None = None, bold: bool = False, nl: bool = True, err: bool = False) -> None:
...
def echo_critical(
    message: str, bold: bool = False, nl: bool = True, err: bool = True, prefix: bool = True
) -> t.NoReturn:
...
def echo_tabulate(table: t.Any, **kwargs) -> None:
