...
def _get_config_data() -> dict[str, Any] | None:
    ...
    from aiida.manage.configuration import get_config  # noqa: PLC0415
    from aiida.manage.configuration.settings import DEFAULT_CONFIG_FILE_NAME  # noqa: PLC0415
...
def _collect_diagnostics() -> dict[str, Any]:
    ...
    import aiida  # noqa: PLC0415
    from aiida.manage import get_manager  # noqa: PLC0415
...
def _get_log_files() -> list[tuple[str, pathlib.Path]]:
    ...
    try:
        ...
        from aiida.engine.daemon.client import get_daemon_client  # noqa: PLC0415
