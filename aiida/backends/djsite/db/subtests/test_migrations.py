...
#         self.node_work = DbNode(type='node.process.workflow.WorkflowNode.', user_id=default_user.id).save()
#         self.node_work.set_attribute(self.KEY_PROCESS_LABEL_OLD, self.process_label)
#         self.node_work.store()

#         self.node_calc = DbNode(type='node.process.calculation.calcjob.CalcJobNode.', user_id=default_user.id).save()
