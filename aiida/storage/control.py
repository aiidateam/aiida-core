...
def get_unreferenced_keyset(check_consistency: bool = True,
                            aiida_backend: Optional['StorageBackend'] = None) -> Set[str]:
...
def get_repository_info(statistics: bool = False, backend: Optional['StorageBackend'] = None) -> dict:
