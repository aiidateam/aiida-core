...
from aiida.common._core.docs import URL_CONFIG_SCHEMA_COMPATIBILITY
...
def config_needs_migrating(config, filepath: str | None = None):
    ...
    :raises aiida.common.exceptions.ConfigurationVersionError: if the config's oldest compatible version is higher than
        the current
    """
