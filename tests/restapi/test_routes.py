...
class TestRestApi:
    ...
    def init_profile(self, aiida_profile_clean, aiida_localhost):  # pylint: disable=unused-argument
        ...
        calc.ctx.repository.put_object_from_filelike(
        ...
        retrieved_outputs.ctx.repository.put_object_from_filelike(stream, 'calcjob_outputs/aiida.out')
    ...
    def test_repo(self):
        ...
        with self.app.test_client() as client:
            ...
            input_file = load_node(node_uuid).ctx.repository.get_object_content('calcjob_inputs/aiida.in', mode='rb')
