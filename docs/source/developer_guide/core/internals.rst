...
- :py:meth:`~aiida.orm.nodes.node.Node.label` returns the label of the node and can be used as a setter property.

*Description management:*

- :py:meth:`~aiida.orm.nodes.node.Node.description`: the description of the node (more detailed than the label) and can be used as a setter property.
