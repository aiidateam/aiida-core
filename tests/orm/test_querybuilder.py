...
@pytest.mark.usefixtures('clear_database_before_test')
def test_queryhelp(aiida_localhost):
    """
...
@pytest.mark.usefixtures('clear_database_before_test')
def test_recreate_from_queryhelp():
...
@pytest.mark.usefixtures('clear_database_before_test')
def test_corner_case_computer_json(aiida_localhost):
    """
...
class TestManager:
    ...
    def test_statistics(self):
        ...
        qmanager = backend.query_manager
...
@pytest.mark.usefixtures('clear_database_before_test')
def test_statistics_default_class(aiida_localhost):
    """
    In this test case we check if QueryBuilder returns the correct results
    ...
    expected_dict = {
        ...
        'name': aiida_localhost.label,
        'transport_type': aiida_localhost.transport_type,
        'id': aiida_localhost.id,
