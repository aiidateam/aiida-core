...
from ._defaults import HEARTBEAT_IVL, HEARTBEAT_TIMEOUT, POLL_TIMEOUT
from ._protocol import MessageType, decode_message, encode_message
...
class ZmqBrokerServer:
    ...
    def _probe_workers(self) -> None:
        ...
        from ._protocol import make_ping
