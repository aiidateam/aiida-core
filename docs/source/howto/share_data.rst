...
For a guide on browsing AiiDA archives interactively through RenkuLab without a local installation, see also
`One-click exploration of AiiDA archives via RenkuLab <https://aiida.net/news/posts/2025-10-10-aiida-renku-integration.html>`__.
