...
def test_calc_attributes_keys(perform_migrations: Migrator):
    """Test the migration of the keys of certain attribute for ProcessNodes and CalcJobNodes."""
    # starting revision
    perform_migrations.migrate_down('e72ad251bcdb')  # e72ad251bcdb_dbgroup_class_change_type_string_values
    ...
    # migrate up
    perform_migrations.migrate_up('7ca08c391c49')  # 7ca08c391c49_calc_job_option_attribute_keys
