...
class CalcJobMonitors:
    ...
    :class:`~aiida.engine.processes.calcjobs._monitors.CalcJobMonitor`, which are stored as an ordered dictionary. The
    ...
    The :meth:`~aiida.engine.processes.calcjobs._monitors.CalcJobMonitors.process` method can be called providing an
