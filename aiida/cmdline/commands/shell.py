...
@click.option('-i', '--interface', type=click.Choice(shells),
...
def shell(plain, no_startup, interface):
    echo.echo("Hello")
    echo.echo("plain :" + str(plain))
    echo.echo("no_startup :" + str(no_startup))
    echo.echo("interface :" + str(interface))

    def get_start_namespace():
        print "get_start_namespace is run"
