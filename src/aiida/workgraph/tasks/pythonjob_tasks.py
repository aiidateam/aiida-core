...
from aiida.pythonjob import pyfunction, PythonJob, PyFunction, MonitorPyFunction
from aiida.workgraph.task import Task
from aiida.workgraph.enums import TaskAction, TaskState
from aiida.node_graph.socket_spec import SocketSpec, SocketSpecSelect, SocketMeta
...
from aiida.node_graph.error_handler import ErrorHandlerSpec
...
class PythonJobTask(BaseSerializablePythonTask):
    ...
    def execute(self, engine_process, args=None, kwargs=None, var_kwargs=None):
        ...
        """
        from aiida.pythonjob import prepare_pythonjob_inputs
...
class PyFunctionTask(BaseSerializablePythonTask):
    ...
    def execute(self, args=None, kwargs=None, var_kwargs=None, engine_process=None):
        from aiida.pythonjob import prepare_pyfunction_inputs
...
class MonitorFunctionTask(BaseSerializablePythonTask):
    ...
    def execute(self, args=None, kwargs=None, var_kwargs=None, engine_process=None):
        from aiida.pythonjob import prepare_monitor_function_inputs
