...
from aiida.cmdline.params.options._commands import setup as options_setup
...
def quicksetup(
    ...
    from aiida.manage._external.postgres import Postgres, manual_setup_instructions
