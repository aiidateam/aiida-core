        ...
        for calculation in calculations:
            ...
            try:
                if control_panel.play_process(calculation.pk):
                    ...
                    echo.echo_error('problem playing Calculation<{}>'.format(calculation.pk))
            except (RemoteException, DeliveryFailed) as e:
                echo.echo_error('failed to play Calculation<{}>: {}'.format(calculation.pk, e.message))
