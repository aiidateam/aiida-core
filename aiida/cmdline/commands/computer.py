...
class Computer(VerdiCommandWithSubcommands):
    ...
    def computer_setup(self, *args):
        ...
        setup.main(args=args, prog_name='verdi computer setup', standalone_mode=False)
    ...
    def computer_configure(self, *args):
        ...
        configure.main(args=args, prog_name='verdi computer configure', standalone_mode=False)
