...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Element', fields ['Z']
        db.create_unique('aidadb_element', ['Z'])


    def backwards(self, orm):
        # Removing unique constraint on 'Element', fields ['Z']
        db.delete_unique('aidadb_element', ['Z'])
