...
def test_group_renaming(perform_migrations: Migrator):
    """Test the migration that renames the DbGroup type strings."""
    # starting revision
    perform_migrations.migrate_down('b8b23ddefad4')  # b8b23ddefad4_dbgroup_name_to_label_type_to_type_string.py
    ...
    # migrate up
    perform_migrations.migrate_up('e72ad251bcdb')  # e72ad251bcdb_dbgroup_class_change_type_string_values.py
