...
class SqlaQueryBuilder(BackendQueryBuilder):
    ...
    @property
    def Node(self):
        import aiida.backends.psql_dos.models.node
        return aiida.backends.psql_dos.models.node.DbNode

    @property
    def Link(self):
        import aiida.backends.psql_dos.models.node
        return aiida.backends.psql_dos.models.node.DbLink

    @property
    def Computer(self):
        import aiida.backends.psql_dos.models.computer
        return aiida.backends.psql_dos.models.computer.DbComputer

    @property
    def User(self):
        import aiida.backends.psql_dos.models.user
        return aiida.backends.psql_dos.models.user.DbUser

    @property
    def Group(self):
        import aiida.backends.psql_dos.models.group
        return aiida.backends.psql_dos.models.group.DbGroup

    @property
    def AuthInfo(self):
        import aiida.backends.psql_dos.models.authinfo
        return aiida.backends.psql_dos.models.authinfo.DbAuthInfo

    @property
    def Comment(self):
        import aiida.backends.psql_dos.models.comment
        return aiida.backends.psql_dos.models.comment.DbComment

    @property
    def Log(self):
        import aiida.backends.psql_dos.models.log
        return aiida.backends.psql_dos.models.log.DbLog

    @property
    def table_groups_nodes(self):
        import aiida.backends.psql_dos.models.group
        return aiida.backends.psql_dos.models.group.table_groups_nodes
