...
def valid_projections():
    ...
    """
    from aiida.tools._query.calculation import CalculationQueryBuilder
...
def process_list(
    ...
    from aiida.cmdline._commands.cmd_daemon import execute_client_command
...
def process_repair(manager, broker, dry_run, force):
    ...
    """
    from aiida.engine.processes._control import get_active_processes, get_process_tasks, iterate_process_tasks
