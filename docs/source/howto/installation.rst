...
.. dropdown:: Benchmark workflow engine performance
    ...
    Here, 100 ``ArithmeticAddCalculation``s completed in ~47s (including the time needed to submit them), corresponding to an average of half a second per process.
