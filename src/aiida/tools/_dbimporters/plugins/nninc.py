...
from aiida.tools._dbimporters.baseclasses import DbImporter, DbSearchResults, UpfEntry
...
class NnincDbImporter(DbImporter):
    ...
    def query(self, **kwargs):
        ...
        :return: an instance of
            :py:class:`aiida.tools._dbimporters.plugins.nninc.NnincSearchResults`.
        """
        import re
...
class NnincEntry(UpfEntry):
    ...
    def __init__(self, uri, **kwargs):
        ...
        :py:class:`aiida.tools._dbimporters.plugins.nninc.NnincEntry`, related
        to the supplied URI.
        """
        super().__init__(
