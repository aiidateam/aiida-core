...
class UniqueTest(unittest.TestCase):
    ...
    def test_query_string(self):
        ...
        utils.input = lambda _: ""
        self.assertEqual(utils.query_string("", "Def_answer"), "Def_answer")

        # The answer should be returned when the an answer is given by
        # the user
        utils.input = lambda _: "Usr_answer"
        self.assertEqual(utils.query_string("", "Def_answer"), "Usr_answer")
    ...
    def test_ask_backup_question(self):
        ...
        with Capturing():
            ...
            utils.input = lambda _: answers[self.array_counter()]
            self.assertEqual(utils.ask_question("", datetime.datetime, False), parse(answers[2]))
    ...
    def test_patterns(self):
        ...
        for pattern, match_true, match_false in [(r"aa\_a%a_b",
            ...
            for sample in match_true:
                self.assertTrue(
                    utils.sql_string_match(string=sample, pattern=pattern),
