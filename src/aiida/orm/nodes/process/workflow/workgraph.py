...
###########################################################################
"""Module with `Node` sub class for work graph processes."""
...
class WorkGraphNode(WorkChainNode):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Use the same logger as WorkChainNode, this ensures the log level is set correctly. `getLogger` is
        # statically typed as returning a `Logger`, but at runtime aiida's global logger class makes it the
        # `AiidaLoggerType` that `_logger` expects.
        self._logger = logging.getLogger(  # type: ignore[assignment]
    ...
    def get_task_state(self, task_name: str) -> str | None:
    ...
    def get_task_process(self, task_name: str) -> str | None:
    ...
    def get_task_action(self, task_name: str) -> str | None:
    ...
    def get_task_map_info(self, task_name: str) -> str | None:
