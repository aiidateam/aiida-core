...
```bash
uv pip install "aiida-core>=2.9" git+https://github.com/aiidateam/aiida-shell git+https://github.com/GeigerJ2/aiida-workgraph.git@fix/map-zone-output-retrieval git+https://github.com/GeigerJ2/gsrd.git@fix/dont-raise-on-trivial-state
```
