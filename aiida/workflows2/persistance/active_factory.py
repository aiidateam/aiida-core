...
import aiida.workflows2.persistance.file_process_record as file_store
...
def create_process_record(process, inputs):
    return file_store.FileProcessRecord(process, inputs)
...
def load_all_process_records():
    return file_store.FileProcessRecord.load_all()
