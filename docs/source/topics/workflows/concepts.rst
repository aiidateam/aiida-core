...
.. warning::
    ...
    You can find a more detailed explanation for the reasoning behind this design choice in the documentation on the various :ref:`process types<topics:processes:concepts:types>` present in AiiDA and the :ref:`implementation of the provenance graph<concepts_provenance_implementation>`.
