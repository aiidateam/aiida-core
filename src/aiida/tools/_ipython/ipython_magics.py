...
class AiiDALoaderMagics(magic.Magics):
    ...
    def verdi(self, line='', local_ns=None):
        ...
        * The ``VerdiCommandGroup`` group ensures that the context ``obj`` is set with the loaded ``Config`` and
          ...
          the ``obj`` keyword.
        * We cannot call the ``aiida.cmdline._commands.cmd_verdi.verdi`` command directly, as that will invoke the
    ...
    def aiida(self, line='', local_ns=None):
        ...
        """
        from aiida.cmdline.utils._shell import get_start_namespace
...
def load_ipython_extension(ipython):
    ...
    .. deprecated:: v3.0.0
        Use :py:func:`~aiida.tools._ipython.ipython_magics.register_ipython_extension` instead.
    """
