...
from aiida.node_graph.analysis import GraphAnalysis
from aiida.node_graph.config import BUILTIN_TASKS
from aiida.node_graph.socket import BaseSocket, TaskSocketNamespace
...
class WorkGraph(node_graph.Graph):
    ...
    def to_widget_value(self) -> Dict[str, Any]:
        ...
        from aiida.workgraph.utils import workgraph_to_short_json, wait_to_link
