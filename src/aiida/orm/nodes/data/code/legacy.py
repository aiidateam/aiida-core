...
class Code(AbstractCode):
    ...
    * Remote code: it is a pair (remotecomputer, remotepath_of_executable) set using the \
    ...
    class Model(AbstractCode.Model):
        ...
        input_plugin: str | None = MetadataField(description='The name of the input plugin to be used for this code')
        local_executable: str | None = MetadataField(description='Path to a local executable')
        remote_exec_path: str | None = MetadataField(description='Remote path to executable')
        is_local: bool | None = MetadataField(description='Whether the code is local or remote')
