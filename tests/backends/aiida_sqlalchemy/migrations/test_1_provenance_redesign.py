...
def test_provenance_redesign(perform_migrations: Migrator):
    ...
    """
    # starting revision
    perform_migrations.migrate_down('140c971ae0a3')  # 140c971ae0a3_migrate_builtin_calculations
    ...
    # migrate up
    perform_migrations.migrate_up('239cea6d2452')  # 239cea6d2452_provenance_redesign
