...
.. note:: 
    ...
    However, in general, you will pass the fields to set directly to the :meth:`set_option <aiida.orm.node.process.calculation.calcjob.CalcJobNode.set_option>` method of a :class:`CalcJobNode <aiida.orm.node.process.calculation.calcjob.CalcJobNode>` object with the ``resources`` key. For instance::
...
or, even better, directly calling the :meth:`set_option <aiida.orm.node.process.calculation.calcjob.CalcJobNode.set_option>` method of the :class:`CalcJobNode <aiida.orm.node.process.calculation.calcjob.CalcJobNode>` class (assuming here that ``calc`` is your calculation object) for the ``resources`` key::
...
* even better, directly calling the :meth:`set_option <aiida.orm.node.process.calculation.calcjob.CalcJobNode.set_option>` method of the :meth:`CalcJobNode <aiida.orm.node.process.calculation.calcjob.CalcJobNode>` class (assuming here that ``calc`` is your calculation object) for the ``resources`` key::
