...
###########################################################################
# pylint: disable=no-self-use,too-many-lines,invalid-name,protected-access
...
def test_query_with_subclasses(aiida_localhost):
    """
    ...
    extra_name = 'test_query_with_subclasses'
