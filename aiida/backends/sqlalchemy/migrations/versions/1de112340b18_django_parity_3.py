...
MISSING_VARCHAR_INDEXES = (
    ...
    ('db_dbgroup', ('label',), 'db_dbgroup_label_58d3f722_like'),
    ('db_dbgroup', ('type_string',), 'db_dbgroup_type_string_fbc22a27_like'),
    ...
    ('db_dbnode', ('node_type',), 'db_dbnode_node_type_a839c5c4_like'),
...
# table name, column names, unique, old column name, new column name
RENAMED_INDEXES = (
    ('db_dbgroup', ('label',), False, 'ix_db_dbgroup_label', 'db_dbgroup_label_58d3f722'),
    ('db_dbgroup', ('type_string',), False, 'ix_db_dbgroup_type_string', 'db_dbgroup_type_string_fbc22a27'),
    (
    ...
    ('db_dbnode', ('node_type',), False, 'ix_db_dbnode_node_type', 'db_dbnode_node_type_a839c5c4'),
...
def upgrade():
    """Add indexes."""
    # drop unique constraints, which are replaced by unique indexes
