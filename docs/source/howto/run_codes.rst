...
For a guide on running external codes without writing a dedicated plugin, and on monitoring
calculations while they are running, see also these blog posts:
