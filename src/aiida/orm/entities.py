...
class EntityCollection(abc.ABC, t.Generic[_EntityT]):
    ...
    def get_one_by_identifier(self, identifier: object) -> _EntityT:
        ...
        msg = f'Invalid identifier type: {type(identifier)}'
        raise TypeError(msg)
...
class Entity(abc.ABC, t.Generic[_BackendEntityT, _CollectionT]):
    ...
    @classproperty
    def collection(cls: type[_EntityT]) -> _CollectionT:  # noqa: N805
