...
def test_node_repository_metadata(perform_migrations: Migrator):
    ...
    """
    # starting revision
    perform_migrations.migrate_down('0edcdd5a30f0')  # 0edcdd5a30f0_dbgroup_extras.py
    ...
    # migrate up
    perform_migrations.migrate_up('7536a82b2cc4')  # 7536a82b2cc4_add_node_repository_metadata.py
...
def test_entry_point_core_prefix(perform_migrations: Migrator):
    ...
    """
    # starting revision
    perform_migrations.migrate_down('535039300e4a')  # 535039300e4a_computer_name_to_label.py
    ...
    # migrate up
    perform_migrations.migrate_up('34a831f4286d')  # 34a831f4286d_entry_point_core_prefix
...
def test_repository_migration(perform_migrations: Migrator):  # pylint: disable=too-many-statements
    ...
    """
    # starting revision
    perform_migrations.migrate_down('7536a82b2cc4')
    ...
    with perform_migrations.session() as session:
        ...
        with open(
            os.path.join(utils.get_node_repository_sub_folder(node_05.uuid, 'raw_input'), 'input.txt'),
            'w',
            encoding='utf-8',
        ) as handle:
            handle.write('input')
    ...
    # migrate up
    perform_migrations.migrate_up('1feaea71bd5a')
...
def test_computer_name_to_label(perform_migrations: Migrator):
    ...
    """
    # starting revision
    perform_migrations.migrate_down('1feaea71bd5a')  # 1feaea71bd5a_migrate_repository
    ...
    # migrate up
    perform_migrations.migrate_up('535039300e4a')  # 5ddd24e52864_dbnode_type_to_dbnode_node_type
