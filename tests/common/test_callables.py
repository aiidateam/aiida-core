...
def test_resolves_here(value, expected):
    """Test :func:`~aiida.common.callables.resolves_here`."""
...
def test_resolves_in_walks_a_dotted_name():
    ...
    assert callables.resolves_in(callables.resolves_here, sys.path) is True
...
def test_resolves_in_a_path_that_lacks_the_module(local_module, tmp_path):
    ...
    """
    assert callables.resolves_here(local_module.compute) is True
