...
from aiida.cmdline.utils import _multi_line_input as multi_line_input
...
def _warn_about_stash_nodes(pks_to_delete: set[int]) -> None:
    ...
    from aiida.calculations._stash import StashCalculation
...
def node_delete(identifier, dry_run, force, clean_workdir, **traversal_rules):
    ...
    if clean_workdir:
        ...
        from aiida.orm.utils._remote import clean_mapping_remote_paths, get_calcjob_remote_paths
